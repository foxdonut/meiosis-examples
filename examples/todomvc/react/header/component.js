...
(function(root, factory) {
  if (typeof define === "function" && define.amd) {
    define(["../../common/header/actions", "../../common/header/receive", "../../common/header/nextAction", "./view.jsx"], function(headerActions, headerReceive, headerNextAction, headerView) {
      return (root.headerComponent = factory(headerActions, headerReceive, headerNextAction, headerView));
    });
  }
  else if (typeof module === "object" && module.exports) {
    module.exports = (root.headerComponent = factory(require("../../common/header/actions"), require("../../common/header/receive"), require("../../common/header/nextAction"), require("./view.jsx")));
  }
  else {

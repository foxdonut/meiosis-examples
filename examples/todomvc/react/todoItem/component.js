...
(function(root, factory) {
  if (typeof define === "function" && define.amd) {
    define(["../../common/todoItem/actions", "../../common/todoItem/state", "../../common/todoItem/display", "./view.jsx", "../../common/todoItem/receive", "../todoEdit/component"], function(todoItemActions, todoItemState, todoItemDisplay, todoItemView, todoItemReceive, todoEditComponent) {
    ...
    module.exports = (root.todoItemComponent = factory(require("../../common/todoItem/actions"), require("../../common/todoItem/state"), require("../../common/todoItem/display"), require("./view.jsx"), require("../../common/todoItem/receive"), require("../todoEdit/component")));
  }
  else {

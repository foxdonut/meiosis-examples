...
(function(root, factory) {
  if (typeof define === "function" && define.amd) {
    define(["../../common/todoEdit/actions", "./view.jsx", "../../common/todoEdit/display", "../../common/todoEdit/receive", "../../common/todoItem/state"], function(todoEditActions, todoEditView, todoEditDisplay, todoEditReceive, todoItemState) {
      return (root.todoEditComponent = factory(todoEditActions, todoEditView, todoEditDisplay, todoEditReceive, todoItemState));
    });
  }
  else if (typeof module === "object" && module.exports) {
    module.exports = (root.todoEditComponent = factory(require("../../common/todoEdit/actions"), require("./view.jsx"), require("../../common/todoEdit/display"), require("../../common/todoEdit/receive"), require("../../common/todoItem/state")));
  }
  else {

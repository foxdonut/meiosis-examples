...
(function(root, factory) {
  if (typeof define === "function" && define.amd) {
    define(["../../common/todoEdit/actions", "./view", "../../common/todoEdit/display", "../../common/todoEdit/receive", "../../common/todoEdit/postRender", "./ready", "../../common/todoItem/state"], function(todoEditActions, todoEditView, todoEditDisplay, todoEditReceive, todoEditPostRender, todoEditReady, todoItemState) {
    ...
    module.exports = (root.todoEditComponent = factory(require("../../common/todoEdit/actions"), require("./view"), require("../../common/todoEdit/display"), require("../../common/todoEdit/receive"), require("../../common/todoEdit/postRender"), require("./ready"), require("../../common/todoItem/state")));
  }
  else {

...
(function(root, moduleName, depNames, depVars, factory) {
  ...
  "headerComponent",
  ["./actions", "./nextUpdate", "variant/header/view", "variant/header/ready"],
  ["headerActions", "headerNextUpdate", "headerView", "headerReady"],

  function(headerActions, headerNextUpdate, headerView, headerReady) {

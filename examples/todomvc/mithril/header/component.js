...
(function(root, factory) {
  if (typeof define === "function" && define.amd) {
    define(["../../common/header/actions", "../../common/header/receive", "./view"], function(headerActions, headerReceive, headerView) {
      return (root.headerComponent = factory(headerActions, headerReceive, headerView));
    });
  }
  else if (typeof module === "object" && module.exports) {
    module.exports = (root.headerComponent = factory(require("../../common/header/actions"), require("../../common/header/receive"), require("./view")));
  }
  else {
